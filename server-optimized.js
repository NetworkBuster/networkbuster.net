...
app.use(
  "/blog",
  express.static(path.join(__dirname, "blog"), {
    maxAge: STATIC_CACHE_DURATION,
  }),
);
app.use(
  "/dashboard",
...
app.use(
  "/overlay",
  express.static(path.join(__dirname, "challengerepo/real-time-overlay/dist"), {
    maxAge: STATIC_CACHE_DURATION,
  }),
);
app.use(
...
app.get("/overlay*", (req, res) => {
  res.set("Cache-Control", "public, max-age=3600");
  res.sendFile(
    path.join(__dirname, "challengerepo/real-time-overlay/dist/index.html"),
  );
});
