...
function showModuleDetails(module) {
  const moduleInfo = {
    ...
    thermal:
      "Thermal Processing Chamber: Pyrolysis system for plastics operating at 150-400°C in vacuum.",
    mechanical:
      "Mechanical Processing Chamber: Grinding, milling, and compaction for metals and glass.",
    biological:
      "Biological Processing Chamber: Composting and anaerobic digestion for organic waste.",
    output:
      "Output Management System: Automated packaging with RFID tracking and inventory management.",
  };
...
// Console easter egg
console.log(
  "%c🌙 NetworkBuster Lunar Recycling System",
  "font-size: 20px; font-weight: bold; color: #6366f1;",
);
console.log(
  "%cVersion 1.0.0 | Payload: 500g+ | Recovery: 95%%",
  "font-size: 12px; color: #94a3b8;",
);
console.log(
  "%cFor more information, visit the documentation.",
  "font-size: 12px; color: #94a3b8;",
);
