...
const NAVIGATION = {
  ...
  lunar: {
    ...
    functionHub: {
      path: "/function-hub.html",
      label: "Function Hub",
      icon: "⚙️",
    },
    flashCommands: {
      path: "/flash-commands.html",
      label: "Flash Commands",
      icon: "⚡",
    },
  },
  ...
  aiworld: {
    main: {
      path: "/challengerepo/real-time-overlay/",
      label: "AI World",
      icon: "🤖",
    },
    avatarWorld: {
      path: "/challengerepo/real-time-overlay/src/components/AvatarWorld.jsx",
      label: "Avatar World",
      icon: "👤",
    },
    satelliteMap: {
      path: "/challengerepo/real-time-overlay/src/components/SatelliteMap.jsx",
      label: "Satellite Map",
      icon: "🛰️",
    },
    cameraFeed: {
      path: "/challengerepo/real-time-overlay/src/components/CameraFeed.jsx",
      label: "Camera Feed",
      icon: "📹",
    },
    connectionGraph: {
      path: "/challengerepo/real-time-overlay/src/components/ConnectionGraph.jsx",
      label: "Connection Graph",
      icon: "🔗",
    },
    immersiveReader: {
      path: "/challengerepo/real-time-overlay/src/components/ImmersiveReader.jsx",
...
const BUTTONS = {
  ...
  action: {
    ...
    startStream: {
      label: "🎵 Start Stream",
      action: "post",
      target: "/api/audio/stream/create",
      class: "btn-action",
    },
  },
};
